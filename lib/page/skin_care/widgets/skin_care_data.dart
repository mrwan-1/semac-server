...
class SkinCareData extends StatefulWidget {
  SkinCareData({super.key,  this.title});
   String? title;
  @override
  State<SkinCareData> createState() => _SkinCareDataState();
}

class _SkinCareDataState extends State<SkinCareData> {
  GlobalKey<FormState> formState = new GlobalKey<FormState>();
  CollectionReference skinCareref = FirebaseFirestore.instance.collection('skinCare');
  add(BuildContext context) async {
    var formdata = formState.currentState;
if (file == null)return Get.snackbar(
  ...
  getimage() async {
    ...
    if (picked != null) {
      ...
      ref = FirebaseStorage.instance.ref('skinCare').child('$nameImage');
    }
