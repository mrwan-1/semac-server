...
class EditSkin extends StatefulWidget {
  EditSkin({super.key, this.title, this.docid,this.list});
 final String? title;
  final String? docid;
  var list;

  @override
  State<EditSkin> createState() => _EditSkinState();
}

class _EditSkinState extends State<EditSkin> {
  GlobalKey<FormState> formState = new GlobalKey<FormState>();
  CollectionReference skinref = FirebaseFirestore.instance.collection('skinCare');
...
if(file == null)
{
    if (formdata!.validate()) {
      EasyLoading.show();
      formdata.save();
        await skinref.doc(widget.docid).update({
          'name': title,
          'def': prais,
          'doc': doc,
