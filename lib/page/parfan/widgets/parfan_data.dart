...
class ParfanData extends StatefulWidget {
  ParfanData({super.key, this.title});
  String? title;
  @override
  State<ParfanData> createState() => _ParfanDataState();
}

class _ParfanDataState extends State<ParfanData> {
