...
class MackupData extends StatefulWidget {
  MackupData({super.key, this.title});
  String? title;
  @override
  State<MackupData> createState() => _MackupDataState();
}

class _MackupDataState extends State<MackupData> {
                ...
                InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        // image: DecorationImage(image: FileImage(File(file.toString()))),
                        color: Kbackdrung,
