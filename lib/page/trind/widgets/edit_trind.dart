...
class EditTrind extends StatefulWidget {
  EditTrind({super.key, this.title, this.docid,this.list});
 final String? title;
  final String? docid;
  var list;

  @override
  State<EditTrind> createState() => _EditTrindState();
}

class _EditTrindState extends State<EditTrind> {
...
if(file == null)
{
    if (formdata!.validate()) {
      EasyLoading.show();
      formdata.save();
        await trindref.doc(widget.docid).update({
          'name': title,
          'def': prais,
          'doc': doc,
